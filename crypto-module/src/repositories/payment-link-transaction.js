...
const modelName = 'PaymentLinkTransaction'
...
const findOnePaymentLinkTransactionWithId = async (database, id, transaction = null) => {
    const options = transaction ? { transaction } : {};
...
const findPaymentLinkTransactionByTransactionId = async (database, transactionId) => {
    return await model.findOne(database, modelName, { transactionId }, [], [], {nest: true, plain: true });
}

const findPaymentLinkTransactionByPaymentLinkId = async (database, paymentLinkId) => {
    return await model.findOne(database, modelName, { paymentLinkId }, [], [], {nest: true, plain: true });
}
...
module.exports = {
    ...
    // findOne,
    findByPk,
    findOnePaymentLinkTransactionWithId,
    // update,
    // destroy,
    // findAll
    findPaymentLinkTransactionByTransactionId,
    findPaymentLinkTransactionByPaymentLinkId
}
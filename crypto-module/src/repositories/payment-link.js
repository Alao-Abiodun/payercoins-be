...
const modelName = 'PaymentLink'

const create = async (database, data = { reference, clientId, amount, amountType, type, avaialableCrypto, status, metaData, expiresAt }, transaction = null) => {
...
const findOneWithPaymentLinkTransactionUsingId = async (database, id) => {
...
module.exports = {
    ...
    updateWithId,
    findOneWithPaymentLinkTransactionUsingId,
    // findAllWithCrypto,
    // findAll,
